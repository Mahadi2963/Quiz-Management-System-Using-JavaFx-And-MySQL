...
public class deleteQuestion extends javax.swing.JFrame {
    ...
    private void renumberQuestions() {
        try {
            ...
            // Counter for new question numbers
            int newID = 1;

            // Loop through the result set and update question IDs
            while (rs.next()) {
                int oldID = rs.getInt("id");
                if (oldID != newID) {
                    PreparedStatement ps = con.prepareStatement("UPDATE question SET id=? WHERE id=?");
                    ps.setInt(1, newID);
                    ps.setInt(2, oldID);
                    ps.executeUpdate();
                }
            ...
            // Reset the sequence to ensure the next ID is correctly generated
            PreparedStatement resetSequence = con.prepareStatement("ALTER TABLE question AUTO_INCREMENT=1");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if(rs.first())
            {
                ...
                JFrame jf = new JFrame();
                jf.setAlwaysOnTop(true);
                JOptionPane.showMessageDialog(jf, "Question Id does not Exixts.");
            }
        }
        catch(Exception e){
            JFrame jf = new JFrame();
...
*/
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        try {
            ...
            if (deletedRows > 0) {
                renumberQuestions(); // Call method to renumber questions
                JFrame jf = new JFrame();
                jf.setAlwaysOnTop(true);
                JOptionPane.showMessageDialog(jf, "Successfully Deleted");
                setVisible(false);
                ...
                JFrame jf = new JFrame();
                jf.setAlwaysOnTop(true);
                JOptionPane.showMessageDialog(jf, "Failed to delete question. Please check the ID.");
            }
        } catch (Exception e) {
            // Handle exceptions
            JFrame jf = new JFrame();
